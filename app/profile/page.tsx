...
import { PhotoVideoCapture, SocialSharing, CalendarIntegration, DataExport } from "@/components/integration-interfaces"
  ...
  return (
    <div className="container mx-auto p-4 space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground">Track progress and manage your training data</p>
      </div>
