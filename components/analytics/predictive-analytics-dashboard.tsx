                  ...
                  <div className='flex items-center justify-between mb-4'>
                    <div>
                      ...
                      <p className='text-sm text-muted-foreground'>
                        Current: {forecast.currentMax} lbs → Predicted:{' '}
                        {forecast.predictedMax.toFixed(1)} lbs
                      </p>
                    </div>
                    <div className='text-right'>
                      <Badge
                        className={getConfidenceBadge(forecast.confidence)}
                      >
                    ...
                    <div>
                      <div className='flex items-center justify-between mb-1'>
                        ...
                        <span className='text-sm text-muted-foreground'>
                          {(forecast.factors.historicalProgress * 100).toFixed(
                            0
                          )}
                          %
                        </span>
                      ...
                      <Progress
                        value={forecast.factors.historicalProgress * 100}
                        className='h-2'
                      />
                    </div>
                    <div>
                      ...
                      <Progress
                        value={forecast.factors.consistency * 100}
                        className='h-2'
                      />
                    </div>
                    <div>
                      ...
                      <Progress
                        value={forecast.factors.recovery * 100}
                        className='h-2'
                      />
                    </div>
                    <div>
                      ...
                      <Progress
                        value={forecast.factors.nutrition * 100}
                        className='h-2'
                      />
                    </div>
                    <div>
                      ...
                      <Progress
                        value={forecast.factors.sleep * 100}
                        className='h-2'
                      />
                    </div>
                    <div>
                      ...
                      <Progress
                        value={forecast.factors.stress * 100}
                        className='h-2'
                      />
                    </div>
                  </div>
                    ...
                    <div key={index} className='p-3 border rounded-lg'>
                      ...
                      <div className='space-y-1'>
                        ...
                        <ul className='text-xs text-muted-foreground space-y-1'>
                          {factor.contributingFactors.map(
