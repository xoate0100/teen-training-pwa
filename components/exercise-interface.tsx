    ...
    <div className='space-y-4'>
      ...
      <Card>
        <CardHeader className='pb-3'>
          ...
          <Progress
            value={
              ((currentSet + (currentSetData?.completed ? 1 : 0)) /
                exercise.sets) *
              100
            }
            className='h-2'
            ...
            <div className='space-y-2'>
              ...
              <div className='flex items-center gap-3'>
                <Button
                  ...
                  size='icon'
                  onClick={() =>
                    updateSetValue('reps', currentSetData.reps - 1)
                  }
                >
                ...
                <Input
                  ...
                  onChange={e =>
                    updateSetValue('reps', Number.parseInt(e.target.value) || 0)
                  }
            ...
            <div className='space-y-2'>
              ...
              <div className='flex items-center gap-3'>
                <Button
                  ...
                  size='icon'
                  onClick={() =>
                    updateSetValue('weight', currentSetData.weight - 5)
                  }
                >
                  <Minus className='h-4 w-4' />
                </Button>
      ...
      {showRPE && (
        <Card className='border-primary/20'>
          <CardHeader>
            ...
            <p className='text-sm text-muted-foreground'>
              Rate your effort from 1 (very easy) to 10 (maximum effort)
            </p>
          </CardHeader>
          <CardContent className='space-y-4'>
            <div className='space-y-3'>
              ...
              <div className='flex justify-between text-xs text-muted-foreground'>
                ...
                <span className='font-semibold text-primary text-lg'>
                  {currentSetData.rpe}/10
                </span>
                <span>Max Effort</span>
              </div>
            </div>
            <Button
              onClick={() => handleRPESubmit(currentSetData.rpe)}
              className='w-full'
            >
              Submit Rating
            </Button>
