...
export function OfflineFirstDashboard() {
  ...
  >([]);
  const [syncStrategy, setSyncStrategyState] = useState<
  ...
  const handleSyncStrategyChange = (
    strategy: 'immediate' | 'background' | 'manual'
  ) => {
        ...
        <CardContent>
          <div className='space-y-4'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
              ...
              <div className='text-center'>
                <div className='text-2xl font-bold'>
                  {formatCacheSize(cache.cacheSize)}
                </div>
            ...
            <div>
              <div className='flex items-center justify-between mb-2'>
                ...
                <span className='text-sm text-muted-foreground'>
                  {formatCacheSize(cache.cacheSize)} /{' '}
                  {formatCacheSize(cache.maxCacheSize)}
                </span>
              </div>
              <Progress
              ...
              <div className='space-y-4 pt-4 border-t'>
                ...
                <div>
                  ...
                  <div className='flex gap-2'>
                    <Button
                      variant={
                        syncStrategy === 'immediate' ? 'default' : 'outline'
                      }
                      size='sm'
                    ...
                    <Button
                      variant={
                        syncStrategy === 'background' ? 'default' : 'outline'
                      }
                      size='sm'
                    ...
                    <Button
                      variant={
                        syncStrategy === 'manual' ? 'default' : 'outline'
                      }
                      size='sm'
