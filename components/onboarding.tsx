...
import { ChevronRight, ChevronLeft, Target, Zap, Trophy, Heart } from "lucide-react"
  ...
  const steps = [
    {
      ...
      content: (
        <div className="text-center space-y-4">
          ...
          <h3 className="text-xl font-semibold text-balance">Ready to become a volleyball superstar?</h3>
          <p className="text-muted-foreground text-pretty">
            This app will help you train smarter, track your progress, and have fun while getting stronger!
          </p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <div>
            <label className="text-sm font-medium mb-2 block">Volleyball experience?</label>
            <div className="space-y-2">
              {[
                ...
                <Button
                  key={option.value}
                  variant={userProfile.experience === option.value ? "default" : "outline"}
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-muted-foreground text-center">Pick what you want to work on (choose any!):</p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-muted-foreground text-center">Help us make training perfect for you:</p>
          <div className="space-y-3">
            {[
              ...
              <Button
                key={pref.id}
                variant={userProfile.preferences.includes(pref.id) ? "default" : "outline"}
                onClick={() => {
                  setUserProfile((prev) => ({
                    ...prev,
    ...
    },
    {
      ...
      content: (
        <div className="text-center space-y-4">
          <div className="text-6xl mb-4">🎉</div>
          <h3 className="text-xl font-semibold text-balance">Welcome to your training team, {userProfile.name}!</h3>
          ...
          <p className="text-muted-foreground text-pretty">
            Remember: Every athlete is different, and that's what makes you special! We'll adjust everything to help you
            succeed.
          </p>
        </div>
      ),
