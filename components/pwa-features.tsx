      ...
      <AlertDescription>
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Get quick access and offline features</p>
          </div>
  ...
  return (
    <Alert className="border-yellow-200 bg-yellow-50">
      ...
      <AlertDescription className="text-yellow-800">
        You're offline. Some features may be limited, but you can still complete workouts!
      </AlertDescription>
    </Alert>
  )
}
      ...
      <CardContent>
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Get reminders for workouts and check-ins</p>
          </div>
