...
const sessionTemplates = {
  'lower-body-am': {
    ...
    cooldown: [
      { name: 'Static Stretching', duration: '8-10 min', focus: 'Lower body' },
    ],
  },
  'upper-body-am': {
    id: 'upper-body-am',
    ...
    warmup: [
      {
        name: 'Arm Circles & Shoulder Prep',
        duration: '5 min',
  ...
  'skills-pm': {
    ...
    mainWork: [
      ...
      {
        name: 'Setting Practice',
        sets: '3',
        reps: '15-20 sets',
        load: 'Precision focus',
        rest: '90s',
      },
      {
        name: 'Approach & Attack',
        sets: '3',
        reps: '8-12 attacks',
        load: 'Power focus',
        rest: '2 min',
    ...
    cooldown: [
      {
        name: 'Volleyball-Specific Stretching',
        duration: '10 min',
  ...
  if (templateId && sessionTemplates[templateId]) {
    return (
      <SessionTemplateDetail
        template={sessionTemplates[templateId]}
    ...
    <Card className='cursor-pointer hover:shadow-md transition-shadow'>
      ...
      <CardContent className='space-y-3'>
        ...
        <div className='space-y-2 text-sm'>
          <div>
            <span className='font-medium'>Main Work:</span>{' '}
            {template.mainWork.length} exercises
          </div>
          <div>
            <span className='font-medium'>Conditioning:</span>{' '}
            {template.conditioning.length} activities
          </div>
        </div>
