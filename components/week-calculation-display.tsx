            ...
            <div className='flex items-center justify-between'>
              <div className='flex items-center gap-2'>
                ...
                <Badge variant='outline'>
                  {sessionRecommendation.recommendedType
                    .charAt(0)
                    .toUpperCase() +
              ...
              <div className='flex items-center gap-2'>
                ...
                <Badge
                  className={getIntensityColor(sessionRecommendation.intensity)}
                >
                  {getIntensityIcon(sessionRecommendation.intensity)}
                  <span className='ml-1 capitalize'>
                    {sessionRecommendation.intensity}
                  </span>
                </Badge>
              </div>
            </div>
        ...
        <CardContent>
          <div className='space-y-2'>
            <div className='flex justify-between text-sm'>
              ...
              <span>
                {format(new Date(weekDates.startDate), 'MMM dd, yyyy')}
              </span>
            </div>
            <div className='flex justify-between text-sm'>
              <span>Week End:</span>
