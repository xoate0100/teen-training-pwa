...
export function generateWeeklySchedule(week: number): WeeklySchedule[] {
  ...
  schedules.push({
    ...
    exercises: ['burpees', 'mountain_climbers', 'jumping_jacks', 'plank_variations'],
  ...
  schedules.push({
    ...
    exercises: ['jump_squats', 'box_jumps', 'lateral_bounds', 'single_leg_work'],
    duration_minutes: phase.phase === 'deload' ? 30 : 45,
    intensity_modifier: phase.intensity / 10
  })
  ...
  schedules.push({
    ...
    exercises: ['explosive_push_ups', 'medicine_ball_throws', 'battle_ropes', 'core_work'],
    duration_minutes: phase.phase === 'deload' ? 30 : 45,
    intensity_modifier: phase.intensity / 10
  })
  ...
  schedules.push({
    ...
    exercises: ['agility_drills', 'sprint_work', 'sport_specific_movements', 'mobility'],
    duration_minutes: phase.phase === 'deload' ? 25 : 40,
    intensity_modifier: phase.intensity / 10
  })
  ...
  if (week >= 9) {
    schedules.push({
      ...
      exercises: ['depth_jumps', 'reactive_jumps', 'lateral_plyos', 'landing_mechanics'],
      duration_minutes: 30,
    ...
    schedules.push({
      ...
      exercises: ['sprint_intervals', 'change_of_direction', 'reaction_drills', 'coordination'],
      duration_minutes: 30,
      intensity_modifier: 0.8
    })
    ...
    schedules.push({
      ...
      exercises: ['foam_rolling', 'dynamic_stretching', 'yoga_flows', 'breathing_exercises'],
      duration_minutes: 25,
