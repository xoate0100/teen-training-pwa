...
class PWAManager {
   ...
   */
  async saveForSync(type: 'session' | 'checkin' | 'progress', data: any): Promise<void> {
   ...
   */
  async getPendingDataCount(): Promise<{ sessions: number; checkins: number; progress: number }> {
    try {
